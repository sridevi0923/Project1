...
export class AppComponent {
  ...
  name = 'Angular';
  zipCode:any;
  data: any;data1:any;  zcode: any;  url1: any;  ccond: any;  temp: any;  temp_max: any;  temp_min: any;
  ccond1: any;  temp_max1: any;  temp_min1: any;
  ccond2: any;  temp_max2: any;  temp_min2: any;
  ccond3: any;  temp_max3: any;  temp_min3: any;
  ccond4: any;  temp_max4: any;  temp_min4: any;
  ccond5: any;  temp_max5: any;  temp_min5: any;
  d = new Date();
  day1: any;  mon1: any;  date1: any;  day2: any;  mon2: any;  date2: any;
  day3: any;  mon3: any;  date3: any;  day4: any;  mon4: any;  date4: any;
  day5: any;  mon5: any;  date5: any;
  ...
  getData() {
    const url = 'http://api.openweathermap.org/data/2.5/weather?lat=35&lon=139&appid=5a4b2d457ecbef9eb2a71e480b947604';
    const url1 = 'http://api.openweathermap.org/data/2.5/forecast?lat=35&lon=139&appid=5a4b2d457ecbef9eb2a71e480b947604'
    this.http.get(url).subscribe((res) => {
      this.data1 = res;
      this.ccond = this.data1.weather[0].main;
      this.temp = this.data1.main.temp;
      this.temp_max = this.data1.main.temp_max;
      this.temp_min = this.data1.main.temp_min;
    ...
    this.http.get(url1).subscribe((res) => {
      ...
      console.log(this.ccond +'  ' +this.temp_min +'   ' +this.temp_max);
